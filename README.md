...
### Small Molecules Features and Samples
These files contain experiments done for the feature and sample selection in Small Molecules. The code used to generate images in Figure 3 and 6 can be found in this file.

### Pathogen Features and Samples
These files contain experiments done for the feature and sample selection in Pathogen. The code used to generate images in Figure 4 and 7 can be found in this file.
